...
public class BindVisitor implements ExprVisitor {
	...
	public void visit(ExprFunction0 func) {
		nodeStack.add(bindGraph.filterFunction(NodeFactory.createLiteral(func.getFunctionSymbol().getSymbol()), Collections.<Node>emptyList()));
	}
	...
	public void visit(ExprFunction3 func) {
		...
		args.add(arg2);
		args.add(arg3);
		nodeStack.add(bindGraph.filterFunction(NodeFactory.createLiteral(func.getFunctionSymbol().getSymbol()), args));
	}
	...
	public void visit(ExprFunctionN func) {
		...
		if (f.getFunctionIRI() != null) {
			nodeStack.add(bindGraph.filterFunction(NodeFactory.createURI(func.getFunctionIRI()), nodes));
		}
		else {
			nodeStack.add(bindGraph.filterFunction(NodeFactory.createLiteral(func.getFunctionSymbol().getSymbol()), nodes));
		}	
	}
