...
import cl.uchile.dcc.visitors.PathVisitor;
...
//					}
					...
					cl.uchile.dcc.visitors.PathVisitor tdv = new cl.uchile.dcc.visitors.PathVisitor(o, this.projectedVars);
					newAns = tdv.getOp();
				}
				else if (o instanceof OpSequence) {
					cl.uchile.dcc.visitors.PathVisitor tdv = new PathVisitor(o, this.projectedVars);
					newAns = tdv.getOp();
				}
				else {
					newAns = o;
